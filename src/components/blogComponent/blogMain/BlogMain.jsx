...
import BlogMainComponent from '../blogMainComponent/BlogMainComponent'
import { useMediaQuery } from 'react-responsive'
import { ShopContext } from '../../../context/ShopContext'

function BlogMain() {
    const { blogItemCollect, setBlogItemCollect } = useContext(ShopContext)
    ...
    return (
        <div className='blogMain'>
            <div className="container">
                <div className="blogMain__inner">
                    {!isMobile ? (<select onChange={handleSortTime} className="blogMain_mobile_filter">
                        <option value="All">All Blog</option>
                        <option value="Featured">Featured</option>
                    </select>) : (
                        <div className="blogMain__filter">
                            <div className="blogMain__filter_left">
                                <p className={`blog ${sortTime}`} onClick={() => setSortTime("All")}>All Blog</p>
                                <p className={`featured ${sortTime}`} onClick={() => setSortTime("Featured")}>Featured</p>
                            </div>
                            <div className="blogMain__filter_right">
                                <div className="blogMain__filter_sort">
                                    <select onChange={handleSortTime} name="productSort" id="productSort">
                                        <option value="All">All</option>
                                        <option value="New">New</option>
                                        <option value="Old">Old</option>
                                    </select>
                                </div>
                                <div className="blogMain__filter_grid">
                                    <div onClick={() => setBlogItemCollect("big")} className="blogMain__filter_grid_box one">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={blogItemCollect === "big" ? "#141718" : "#6C7275"}>
                                    ...
                                    <div onClick={() => setBlogItemCollect("medium")} className="blogMain__filter_grid_box tow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill={blogItemCollect === "medium" ? "#141718" : "#6C7275"}>
                                    ...
                                    <div onClick={() => setBlogItemCollect("small")} className="blogMain__filter_grid_box">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"}>
                                            ...
                                            <path d="M3 6H10.998V18H3V6Z" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"} />
                                            <path d="M13.002 6H21V18H13.002V6Z" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"} />
                                        </svg>
                                    </div>
                                    <div onClick={() => setBlogItemCollect("small")} className="blogMain__filter_grid_box">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"}>
                                            ...
                                            <path d="M6 21.5L6 13.502L18 13.502L18 21.5L6 21.5Z" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"} />
                                            <path d="M6 11.498L6 3.5L18 3.5L18 11.498L6 11.498Z" fill={blogItemCollect === "small" ? "#141718" : "#6C7275"} />
                                        </svg>
                                    </div>
                                </div>
                            </div>
                    ...
                    <BlogMainComponent sortTime={sortTime} />
                    <button className='blogMain_button'>Show more</button>
                </div>
            </div>
        </div>
    )
