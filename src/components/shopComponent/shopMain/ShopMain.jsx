...
import ShopMainProduct from '../shopMainProduct/ShopMainProduct'
import { useMediaQuery } from 'react-responsive'

function ShopMain() {
    const [sort, setSort] = useState("big")
    const [price, setPrice] = useState('400')
    const [itemSize, setItemSize] = useState('big')
    ...
    return (
        <section className='shopMain'>
            <div className="container">
                <div className="shopMain__inner">
                    <div className="shopMain__filter">
                        <div className="shopMain__filter_left">
                            <div className="shopMain__filter_category">
                                ...
                                <select name="productCategory" id="productCategory">
                                    ...
                                    <option value="Bedroom">Dinning</option>
                                    <option value="Bathroom">Outdoor</option>
                                </select>
                            </div>
                            <div className="shopMain__filter_price">
                                <label>PRICE</label>
                                <select onChange={priceSort} name="productPrice" id="productPrice">
                        ...
                        <div className="shopMain__filter_right">
                            <div className="shopMain__filter_sort">
                                <select onChange={sortChange} name="productSort" id="productSort">
                                    <option value="big">Big</option>
                                    <option value="small">Small</option>
                                </select>
                            </div>
                            <div className="shopMain__filter_grid">
                                <div className="shopMain__filter_grid_box one" onClick={() => setItemSize("big")}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={itemSize === "big" ? "#141718" : "#6C7275"}>
                                ...
                                <div className="shopMain__filter_grid_box tow" onClick={() => setItemSize("medium")}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill={itemSize === "medium" ? "#141718" : "#6C7275"}>
                                ...
                                <div className="shopMain__filter_grid_box" onClick={() => setItemSize("small")}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={itemSize === "small" ? "#141718" : "#6C7275"}>
                                        ...
                                        <path d="M3 6H10.998V18H3V6Z" fill={itemSize === "small" ? "#141718" : "#6C7275"} />
                                        <path d="M13.002 6H21V18H13.002V6Z" fill={itemSize === "small" ? "#141718" : "#6C7275"} />
                                    </svg>
                                </div>
                                <div className="shopMain__filter_grid_box" onClick={() => setItemSize("small")}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill={itemSize === "small" ? "#141718" : "#6C7275"}>
                                        ...
                                        <path d="M6 21.5L6 13.502L18 13.502L18 21.5L6 21.5Z" fill={itemSize === "small" ? "#141718" : "#6C7275"} />
                                        <path d="M6 11.498L6 3.5L18 3.5L18 11.498L6 11.498Z" fill={itemSize === "small" ? "#141718" : "#6C7275"} />
                                    </svg>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="shopMain__product">
                        <ShopMainProduct sort={sort} sortPrice={price} itemSize={itemSize} />
                    </div>
                </div>
            </div>
        </section>
